    ...
    <>
      <section className="sec-6">
        <div className="container mx-auto text-center">
          ...
          Ingin <span className="text-color">Membantu</span> Meningkatkan Literasi Anak-Anak Sekitar Kita?
          </h2>
          <h6 className="sec-6__title-2 text-center">
            Percayakan melalui kegiatan kita
          </h6>
          <div>
          <a href="#" className="sec-6__btn text-decoration-none">Donasi dengan Kami
          <img src={btn2}/>
          </a>
          </div>
          <h6 className="sec-6__title-2 text-center">
